(function() {
    ...
    /* @ngInject */
    function DefaultToolbarController($scope,$mdDialog, $injector, $rootScope, $mdMedia, $state, $element, $filter, $mdUtil, $mdSidenav, $mdToast, $timeout, $document,$window, triBreadcrumbsService, triSettings, triLayout, UserService,service) {
        var vm = this;
...
//            console.log('console.log(result.data);',result.data);
//            console.log('console.log(result.data);',result.data);
